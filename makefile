...
$(OBJ)/build/png2bdc.py:
	cp -R prec-build/png.py $(OBJ)/build 
	cp -R prec-build/png2bdc.py $(OBJ)/build 
...
$(OBJ)/%.fh: $(SRC)/%.png $(OBJ)/build/png2bdc.py $(FILE2STR)
	@echo Converting $<...
	@$(OBJ)/build/png2bdc.py $< $(OBJ)/temp.bdc
